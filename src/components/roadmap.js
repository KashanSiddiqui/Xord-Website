...
<div className="roadmap-wrapper">
            ...
            <div className="columns">
                <div className="column is-6 is-offset-3">
                    <div className="roadmap-image">
                        <img src={require("./assets/images/illustrations/world.svg")}/>
                    </div>
                    <h1 className="title is-2 is-light is-semibold is-spaced main-title">2018 Roadmap</h1>
                    <h2 className="subtitle is-5 is-light is-thin">
                        Cryptocurrency brought to the next level. Join our ICO for supercharged rates.
                    </h2>
                    {/* <!-- CTA --> */}
                    <p>
                        <a href="#roadmap" className="button k-button k-primary raised has-gradient is-fat is-bold">
    ...
    <section id="roadmap" className="main-timeline">
        <ul>
            <li>
                <div>
                    <span className="item-title">Platform Launch</span>
            ...
            <li>
                <div>
                    <span className="item-title">Presales starts</span>
            ...
            <li>
                <div>
                    <span className="item-title">ICO starts</span>
            ...
            <li>
                <div>
                    <span className="item-title">ICO phase 2</span>
            ...
            <li>
                <div>
                    <span className="item-title">Development starts</span>
                    <time>May 9th</time> 
                    <span className="item-content">
                        At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium
                    </span>
            ...
            <li>
                <div>
                    <span className="item-title">Krypton Meetup CA</span>
                    <time>June 30th</time> 
                    <span className="item-content">
                        At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium
                    </span>
            ...
            <li>
                <div>
                    <span className="item-title">Krypton Wallet Release</span>
                    <time>July 25th</time> 
                    <span className="item-content">
                        At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium
                    </span>
            ...
            <li>
                <div>
                    <span className="item-title">Chain Alpha Release</span>
            ...
            <li>
                <div>
                    <span className="item-title">Token Sale</span>
            ...
            <li>
                <div>
                    <span className="item-title">Security Audit</span>
            ...
            <li>
                <div>
                    <span className="item-title">Chain Beta Release</span>
    ...
    <section>
        <div className="roadmap-end">
            <img src={require("./assets/images/illustrations/roadmap-end.svg")} alt=""/>
        </div>
